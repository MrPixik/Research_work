...
class Contour_detection:
    ...
    def edgesMarrHildreth(self,image_address, sigma,threshold):
    ...
    def RCR_sobel_edge_detection(self, image_address, kernel_size,sigma, threshold, min_hue, max_hue):
        ...
        a.set_title('Morphology close')
        plt.show()
    def cannyEdge(self, image_address, sigma, gauss_kernel_size, th1, th2):
        image = self.__load_image(image_address)
    ...
    def test_MH(self, image):
        ...
        log = self.edgesMarrHildreth(gray_image, 5, 0.02)
        return log
