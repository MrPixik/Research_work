...
import os
from internal.models.img_processing.My_image_contour_detection import *
    ...
    def sobel_edges(self, origin_video_addr, kernel_size, sigma, threshold):
        ...
        with tqdm(total=total_frames, desc="Processing video") as pbar:
            while True:
                ...
                processed_frame = cd.sobel_edge_detection_result_only(frame, kernel_size, sigma, threshold)
